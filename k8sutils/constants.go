...
func generateGrafanaDashboardJson(redisName string, isCluster bool, namespace string) string {
	...
	`, redisName+postfix, namespace+"-"+redisName+postfix)
}
